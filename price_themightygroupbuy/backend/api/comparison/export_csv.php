...
$rows = runComparisonQuery($productIds, $vendorIds, $specIds, $classificationIds, $multiOnly, $verifiedOnly, $tierKitSize, $rawMaterialOnly, $tabletOnly, $paymentMethods, $cheapestVendorId);
